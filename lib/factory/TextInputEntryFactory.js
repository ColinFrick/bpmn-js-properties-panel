...
var textField = function(options, defaultParameters) {
  ...
  var resource       = defaultParameters,
      ...
      hasPlaceholder = !!options.placeholder && typeof options.placeholder === 'function';
  ...
  resource.html =
    ...
    '<div class="bpp-field-wrapper" ' +
      ...
      '<input id="camunda-' + resource.id + '" type="text" name="' + options.modelProperty+'" ' +
        (hasPlaceholder ? 'data-placeholder="getPlaceholder"' : '') +
        (canBeDisabled ? 'data-disable="isDisabled"' : '') +
        (canBeHidden ? 'data-show="isHidden"' : '') +
        ' />' +
  ...
  if (hasPlaceholder) {
    resource.getPlaceholder = function() {
      return options.placeholder.apply(resource, arguments);
    };
  }
